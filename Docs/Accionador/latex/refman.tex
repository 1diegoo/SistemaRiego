...
\fi
  % Hyperlinks
    ...
    \hypersetup{%
      ...
      unicode,%
      pdftitle={Accionador},%
      pdfsubject={Còdigo del accionador basado en Arduino, escrito en C++}%
    }
...
\input{namespacegbvars}
\chapter{Documentación de clases}
\input{struct_acc_info}
\chapter{Documentación de archivos}
\input{dbg__utils_8h_source}
\input{funcs_8h}
\input{funcs_8h_source}
\input{main_8ino}
\input{states_8h}
\input{states_8h_source}
